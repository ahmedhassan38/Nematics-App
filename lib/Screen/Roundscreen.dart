      ...
      child: Container(
        ...
        child: RaisedButton(
          ...
          onPressed: () {
            ...
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => levelPage()));
          }else{
                          ...
                          children: [
                            Container(
                              ...
                              child: Obx(()=>GridView.count(
                                 ...
                                 children: List.generate(controller.roundModel.value.data!.length, (index){
                                return InkWell(
                                  onTap: (){
                                    setState(() {
                                      selected=List.generate(controller.roundModel.value.data!.length, (index) => false);
                                      selected[index]=true;
                                      controller.CurrentRound.value=int.parse(controller.roundModel.value.data!.elementAt(index).title!.replaceAll('Round #', '').toString());
                                    });
                                  },
                                  child: Container(
                                            height: 60.h,
