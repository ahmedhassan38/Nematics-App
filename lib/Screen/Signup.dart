...
class _SignupPageState extends State<SignupPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation2 = Tween(begin: -1, end: 0.0).animate(
        CurvedAnimation(parent: animationController1!, curve: Curves.bounceIn));
    animationController1!.forward();
    animation3 = Tween(begin: 1, end: 0.0).animate(
        CurvedAnimation(parent: animationController1!, curve: Curves.bounceIn));
    animationController1!.forward();
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          ...
          this.passwordMatched = TextformField.password_.text ==
                  TextformField.confirm_password_.text &&
              !TextformField.password_.text.isEmpty;
          ...
          if (!emailFieldEmpty && (passwordMatched) && !passwordFieldEmpty) {
            ...
            setState(() {
              ...
              passwordMatched = TextformField.password_.text ==
                  TextformField.confirm_password_.text;
            });
          }
        },
                        ...
                        Positioned.fill(
                          child: Column(
                            children: [
                              ...
                              emailFieldEmpty &&
                                      !TextformField.email_.text.contains('@')
                                  ? Text(
                                      'email required (abc@gmail.com)',
                                      style: TextStyle(
                                          color: Colors.red,
