      ...
      child: RaisedButton(
        ...
        onPressed: () async{
          ...
          if (!emailFieldEmpty && !passwordFieldEmpty){
            ...
            UserModel isRegistered = await  auth.login(TextformField.email_.text, TextformField.password_.text);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Transform(
                            transform: Matrix4.translationValues(0,0, animation!.value*MediaQuery.of(context).size.width),
                            child: Container(
                              ...
                              Positioned.fill(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    emailFieldEmpty?Text('email required',style: TextStyle(color: Colors.red,fontWeight: FontWeight.normal,fontSize: 11),):Container(),
                                    TextformField(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: ()async{
                                  var cond = await firebaseAuthController().GoogleSignOpt(false);
                                  if(cond){
                                    SharedPreferences prefs = await SharedPreferences.getInstance();
                                    await prefs.setBool('login', true);
                                    Navigator.pushReplacement(context,
