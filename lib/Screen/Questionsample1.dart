...
import 'Questionsample2.dart';

class Questionsample1Page extends StatefulWidget {
  const Questionsample1Page({Key? key}) : super(key: key);

  @override
  State<Questionsample1Page> createState() => _Questionsample1PageState();
}

class _Questionsample1PageState extends State<Questionsample1Page> with TickerProviderStateMixin {
  Widget Nextbutton({
        ...
        child: RaisedButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => Questionsample2Page()));
          },
