...
class _levelPageState extends State<levelPage> with TickerProviderStateMixin{
  ...
  @override
  void initState() {
    selected=List.generate(controller.roundModel.value.data!.length, (index) =>false);
          ...
          onPressed: () {
            if(controller.CurrentLevel.value!=10000000) {
              ...
              Navigator.pushAndRemoveUntil(context,
                  MaterialPageRoute(
                      builder: (context) => Questionsample1Page()),(route)=>false);
            }else{
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Obx(()=>GridView.count(
                        ...
                        children: List.generate(controller.levelModel.value.data!.length, (index){
                          return InkWell(
                            onTap: (){
                              setState(() {
                                controller.CurrentLevel.value=int.parse(controller.levelModel.value.data!.elementAt(index).title!.replaceAll('Level #', '').toString());
                                selected=List.generate(controller.levelModel.value.data!.length, (index) => false);
                                selected[index]=true;
                              });
                            },
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: selected.elementAt(index)==true?Colors.green:Color(0xffD9D9D9),
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: GoogleFonts.montserrat(
                                    ...
                                    fontSize: 26.sp,
                                    color:selected.elementAt(index)==true?Colors.white:Colors.black,
                                  ),
                                ),
                              ),
                            ),
